      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col items-center text-center">
          <h1 className="font-mono title-font md:text-2xl text-3xl mb-4 font-medium text-white">
            ...
            and I am passionate about using technology to design and build products that foster a safe, better, and inclusive future! I'll introduce myself below! 👇" typingSpeed={48} />
          </h1>
        </div>
      </div>
      <div data-aos="zoom-in-up" className="animate-infinite-scroll container px-5 py-10 mx-auto text-center lg:px-40 items-center justify-center  mt-40 mb-40 font-mono leading-relaxed text-base">
